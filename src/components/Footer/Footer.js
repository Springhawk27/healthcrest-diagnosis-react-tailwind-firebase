            ...
            <footer className="text-gray-600 body-font">
                <div className="container px-12 py-12 mx-auto flex md:items-center lg:items-start md:flex-row md:flex-nowrap flex-wrap flex-col border-t-2">
                    <div className="w-64 flex-shrink-0 md:mx-0 mx-auto text-center md:text-left">
                        <NavLink to="/home" className="flex title-font font-medium items-center md:justify-start justify-center text-gray-900">
                            ...
                            <span className="ml-3 text-lg text-green-600">Healthcrest Diagnosis</span>
                        </NavLink>
                        <p className="mt-2 text-sm text-gray-700">We are here to serve you and ensuring a healthy, sound and beautiful life ahead of you.</p>
                    </div>
                    <div className="flex-grow flex flex-wrap md:pl-20 -mb-10 md:mt-0 mt-10 md:text-left text-center">
                        <div className="lg:w-2/3 md:w-1/3 w-full px-4">
                            ...
                            <nav className="list-none mb-4">
                                ...
                                <p className="mt-2 text-sm text-gray-700">E-mail : info@healthcrestdiagnostic.com
                                </p>
                        ...
                        <div className="lg:w-1/3 md:w-1/3 w-full px-4">
                            ...
                            <nav className="list-none mb-2">
                                <li>
                                    <NavLink to="/services" className="text-gray-600 hover:text-green-500">Services</NavLink>
                                </li>
                                <li>
                                    <NavLink to="/doctors" className="text-gray-600 hover:text-green-500">Doctors</NavLink>
                                </li>
                                <li>
                ...
                <div className="bg-green-200">
                    <div className="container mx-auto py-4 px-5 flex flex-wrap flex-col sm:flex-row">
                        <p className="text-gray-700 text-sm text-center sm:text-left">© 2021 Healthcrest Diagnosis
                        </p>
